              ...
              <div className="row block-lg-one-half block-tab-whole">
                <div className="column">
                  <p className="drop-cap">
                    ...
                    mollitia ut magnam laboriosam. Quisquam neque quia ex
                    eligendi repellat illum quibusdam aut. Architecto quam
                    consequuntur totam ratione reprehenderit est praesentium
                    impedit maiores incididunt adipisicing veniam velit. Duis ex
                    ad cupidatat tempor Excepteur cillum cupidatat fugiat
